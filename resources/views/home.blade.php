  ...
  <main class="main-section-content">
    ...
    <div class="everything-you-need-to-know-section">
      ...
      <div class="feature-card shadow">
        ...
        <div class="feature-card-icon">
          <?xml version="1.0" ?><svg style="enable-background:new 0 0 24 24;" fill="#ed6754" version="1.1" viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="info"/><g id="icons"><path d="M12,4C7.3,4,3.2,6.9,1.2,11.1c-0.3,0.6-0.3,1.3,0,1.9C3.2,17.1,7.3,20,12,20s8.8-2.9,10.8-7.1   c0.3-0.6,0.3-1.3,0-1.9C20.8,6.9,16.7,4,12,4z M12,16c-2.2,0-4-1.8-4-4c0-2.2,1.8-4,4-4s4,1.8,4,4C16,14.2,14.2,16,12,16z" id="view"/></g></svg>
        </div>
        <h3>Transparent</h3>
        <p class="gray-text">
